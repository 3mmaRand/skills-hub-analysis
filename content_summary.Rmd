...
write.table(undoc_user, 
            ...
            row.names = FALSE)
```
"Recordless" users, i.e., those without student records were dropped for this analysis. This included students who graduated or staff. These `r nrow(undoc_user) ` recordless users are [here](../data/)
...
content_use_nonuser %>% flextable() %>% 
  fontsize(size = 10, part = "all") %>% 
  add_header_lines("Distribution on non-uers") 
```
